...
import com.example.applicationvault.navigation.ROUTE_UPDATE_EMPLOYER
import com.example.applicationvault.navigation.ROUTE_VIEW_EMPLOYER

@Composable
fun ViewEmployers(navController: NavHostController){
...
@Composable
fun EmployerItem(companyname:String,jobname:String,email:String,
                 password: String,requirements:String,deadline:String,employerid:String,imageUrl:String,navController: NavHostController,
                ...
                Column {
                    ...
                    Row(horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        Button(onClick = {
                            ...
                            navController.navigate(" $ROUTE_UPDATE_EMPLOYER/$employerid")
                        },
                            shape = RoundedCornerShape(10.dp),
...
@Composable
fun ViewEmployersScreenPreview() {
    ViewEmployers(rememberNavController())
}