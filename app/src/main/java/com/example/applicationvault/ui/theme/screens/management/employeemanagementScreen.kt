package com.example.applicationvault.ui.theme.screens.management
...
@Composable
fun EmployeeManagementScreen(navController: NavController) {
...
fun EmployeeManagementScreenPreview(){
    EmployeeManagementScreen(rememberNavController())
}