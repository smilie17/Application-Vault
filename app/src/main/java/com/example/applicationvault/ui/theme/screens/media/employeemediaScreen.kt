...
@Composable
fun EmployeeMediaScreen(navController: NavController){
    ...
    Column (modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally){
        ...
        Button(onClick = {
            imageUri.value?.let {
                employeeViewModel.uploadEmployeeWithImage(it,context,firstname,lastname,email,password,navController)
...
@Composable
fun EmployeeMediaScreenPreview(){
    EmployeeMediaScreen(rememberNavController())
}