package com.example.applicationvault.ui.theme.screens.health
    ...
    Column (modifier = Modifier.wrapContentWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Column(modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally){
            ...
            OutlinedTextField(
                ...
                label = { Text(text = "Please enter the hospital name") },
                placeholder = { Text(text = "Enter the hospital name") },
                modifier = Modifier.wrapContentWidth()
                    .align(alignment = Alignment.CenterHorizontally)
            )
            OutlinedTextField(
