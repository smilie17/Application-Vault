...
@Composable
fun ItScreen(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally){
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Enter the available job position") },
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Enter the company name") },
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Enter the available job requirements") },
...
@Composable
fun ItScreenPreview(){
    ItScreen(rememberNavController())
}
