package com.example.applicationvault.ui.theme.screens.jobs
...
import com.example.applicationvault.navigation.ROUTE_APPLY

@Composable
fun  ViewJobs(navController: NavController){
            ...
            Row {
                Column {
                    ...
                    Row(horizontalArrangement = Arrangement.SpaceBetween) {
                        Button(onClick = {
                          navController.navigate(ROUTE_APPLY)
                        },
